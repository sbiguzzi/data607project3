...
#skills_df <- read.csv(url("https://raw.githubusercontent.com/sbiguzzi/data607project3/main/skill_word_count.csv"))
...
DS.2 <- DS.2 %>%
  select(position,company_name,inferred_city,inferred_state,job_description,job_type,salary_offered,category)
